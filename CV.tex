...
\cvcustomdata{\faGlobe}{Saint Petersburg, Russia}
\cvcustomdata{\faLinkedin}{\href{https://www.linkedin.com/in/furiousteabag/}{furiousteabag}}
...
\addtobacksidebar{
	...
	\skill[1.8em]{\faCaretRight}{pytorch, transformers}
	...
	\skill[1.8em]{\faCaretRight}{RNNs, attention, transformer}
	\skill[1.8em]{\faCaretRight}{regression, trees, ensembles}
	\skill[1.8em]{\faCaretRight}{clustering, \\ dimensionality reduction}
	\skill[1.8em]{\faCaretRight}{recommender systems, \\ A/B testing}
	% \pointskill{\faCode}{Development}{2}[4]
	% \skill[1.8em]{\faCaretRight}{CI / CD}
...
\begin{cvtable}[1.5]
	...
	\cvitem{2017}
        {Winner}
        {Intercollegiate Math Competition}
